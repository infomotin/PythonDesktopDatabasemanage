...
urlpatterns = [
    ...
    path("<uuid:query_id>/", views.QueryDetailView.as_view(), name="detail"),
    path("<uuid:query_id>/edit/", views.EditQueryView.as_view(), name="edit"),
    path("<uuid:query_id>/delete/", views.DeleteQueryView.as_view(), name="delete"),
